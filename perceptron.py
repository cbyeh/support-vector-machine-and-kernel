...
if __name__ == '__main__':
    ...
    print("Testing perceptron unkernelized... ")
    ...
    print("Getting lists of significant coordinates... ")
    print(get_significant_coordinates(w5, True))
    print(get_significant_coordinates(w5, False))
    print("Testing perceptron kernelized... ")
